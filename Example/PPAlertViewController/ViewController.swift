...
//        self.present(ac, animated: true, completion: nil)
        ...
        let linkAttrSting = NSMutableAttributedString(string: "Terms & Conditons Apply", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 18.0), NSAttributedStringKey.underlineStyle: NSUnderlineStyle.styleSingle.rawValue])
        ...
        let subtitle = PPAlertViewAppearence.Label(text: "A nice subtitle here", textColor: UIColor(red: 0, green: 0, blue: 0, alpha: 0.7), font: UIFont.systemFont(ofSize: 15.0))
